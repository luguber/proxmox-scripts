...
https://nightly.yarnpkg.com/yarn-v1.23.0-20220130.1630.tar.gz
  ...
  os_fetch -O yarn-v$YARN_VERSION.tar.gz https://nightly.yarnpkg.com/yarn-v$YARN_VERSION.tar.gz
 # os_fetch -O yarn-v$YARN_VERSION.tar.gz.asc https://nightly.yarnpkg.com/yarn-v$YARN_VERSION.tar.gz.asc
